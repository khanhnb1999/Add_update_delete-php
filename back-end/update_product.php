    ...
    <div class="tab__login">
        ...
        <form action="update_product.php?product_id=<?= $value['product_id'] ?>" method="post"
            ...
            <div class="mb-3 mt-3">
                ...
                <textarea class="form-control" rows="2" name="product_content"><?=$value['product_content']?></textarea>
            </div>
            <div class="login ">
            ...
            <div class="login ">
                ...
                <input type="date" name="product_created_date" class="form-control" placeholder="Ngày nhập"
                    value="<?=$value['product_created_date']?>">
            </div>
            <!-- <div class="login ">
                <label for="" class="login__label"><b>Ngày xuất</b></label>
                <input type="date" name="product_update_date" class="form-control" placeholder="Ngày xuất" value="">
            </div> -->
            <div class="login ">
                ...
                <select name="catalog_name" class="form-control">
                    ...
                    <option value="<?php echo $cat['catalog_name']; ?>"><?php echo $cat['catalog_name']; ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
            <div class="login ">
                <button type="submit" class="btn btn-danger" name="btn_submit">Update</button>
            </div>
        </form>
    </div>
